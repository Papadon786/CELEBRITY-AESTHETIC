...
// per the reference format across all Crown Celebrity Aesthetic clinical Rx pads.
export const DOCTOR_LETTERHEAD = {
  name: "Naziya Baig",
  qualifications: "Certified Cosmetologist & Trichologist",
  designation: "Lead Cosmetologist & Trichology Specialist",
}
  ...
  return `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div>Generated by Crown Celebrity Aesthetic Electronic Medical Record System</div>
