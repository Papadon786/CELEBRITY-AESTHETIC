...
export const metadata: Metadata = {
  ...
  description:
    "Crown Celebrity Aesthetic is a premier hair and skin clinic offering specialized hair restoration, advanced hair transplants, clinical skin treatments and PMU services, alongside a dedicated IATAM Academy.",
  openGraph: {
    title: SITE_NAME,
